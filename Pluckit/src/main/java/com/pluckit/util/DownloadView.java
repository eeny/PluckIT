...
// 파일 다운로드 유틸 (참고 - https://happy-hs.tistory.com/23)
public class DownloadView {
	public void fileDown(HttpServletRequest request, HttpServletResponse response, String filePath, String realFilNm,
